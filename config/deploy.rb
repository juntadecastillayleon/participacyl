...
set :application, deploysecret(:app_name, default: "participacyl")
set :deploy_to, deploysecret(:deploy_to)
set :ssh_options, port: deploysecret(:ssh_port)

set :repo_url, "https://github.com/juntadecastillayleon/participacyl.git"
...
set :linked_files, %w[config/database.yml config/secrets.yml lib/tasks/data.json]
